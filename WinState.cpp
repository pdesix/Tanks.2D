...
WinState::WinState() : kenvector(new sf::Font()), panelTexture(new sf::Texture()), freeTexture(new sf::Texture()), selectedTexture(new sf::Texture())
{
	...
	label = new Text("Wygrales", kenvector);
...
int WinState::HandleInput(sf::Event & event)
{
